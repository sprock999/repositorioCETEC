...
public class CopiaDeSeguridad extends javax.swing.JFrame {
    ...
    public CopiaDeSeguridad() {
        ...
        icon = new ImageIcon(img.getImage().getScaledInstance(btn_guardar.getWidth(), btn_guardar.getHeight(), Image.SCALE_DEFAULT));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ProcessBuilder mysqldump = new ProcessBuilder("cmd.exe","/c","\"C:\\Program Files\\MySQL\\MySQL Server 5.7\\bin\\mysqldump\" --user=root --password=mysql cetec > " + txt_ruta.getText());
        try {
