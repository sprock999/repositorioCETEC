 ...
 * @author jose_
 */
public class RecuperacionDeDatos extends javax.swing.JFrame {
    ...
    public RecuperacionDeDatos() {
        initComponents();
        this.setTitle("Recuperacion De Datos");
        ...
        img = new ImageIcon(getClass().getResource("/Imagenes/abrir archivo.png"));
        icon = new ImageIcon(img.getImage().getScaledInstance(btn_abrir.getWidth(), btn_abrir.getHeight(), Image.SCALE_DEFAULT));
        btn_abrir.setIcon(icon);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Abrir Archivo De:");
        ...
        jLabel10.setText("Abrir");

        jLabel12.setFont(new java.awt.Font("Californian FB", 1, 14)); // NOI18N
        jLabel12.setText("Salir");

        btn_abrir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/abrir archivo.png"))); // NOI18N
    ...
    private void btn_abrirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_abrirActionPerformed
        try {
            ProcessBuilder mysqldump = new ProcessBuilder("cmd.exe","/c","\"C:\\Program Files\\MySQL\\MySQL Server 5.7\\bin\\mysql\" --user=cetec --password=cetec cetec < " + txt_ruta.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecuperacionDeDatos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RecuperacionDeDatos().setVisible(true);
            }
        });
    }
